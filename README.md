...
- Indkapsling og beskyttelse af data i objekter
- Samspil mellem flere objekter (fx patient, sensor, monitor)
- Øvelser med klasser, metoder og lister af objekter
...
**Husk:** Brug "Think Python" som din primære kilde til litteratur og reference – især kapitel 15-17!
